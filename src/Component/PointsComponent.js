...
const PointsComponent = () => {
  const initialCheckboxes = [
    ...
    { id: 3, label: 'Average', checked: false, imagePath: 'icons/Ellipse13.png' },
    { id: 3, label: 'Poor', checked: false, imagePath: 'icons/Ellipse10.png' },
    { id: 3, label: 'Very Poor', checked: false, imagePath: 'icons/Ellipse15.png' },
    { id: 3, label: 'Unassessed', checked: false, imagePath: 'icons/Ellipse16.png' },
    { id: 3, label: 'Major Potholes', checked: false, imagePath: 'icons/maskorange.png' },
    { id: 3, label: 'Minor Potholes', checked: false, imagePath: 'icons/maskyellow.png' },
    { id: 3, label: 'Patches', checked: false, imagePath: 'icons/maskorange.png' },
    { id: 3, label: 'Cracks', checked: false, imagePath: 'icons/maskyellow.png' },
    { id: 3, label: 'Ravelling', checked: false, imagePath: 'icons/maskorange.png' },
  ];
